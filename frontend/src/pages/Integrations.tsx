  ...
  return (
    <div style={{ background: 'var(--bg)' }}>
      <Section style={{ padding: '120px 0 64px' }} background="default">
        ...
        <h3 style={{ fontSize: 26, fontWeight: 700, marginTop: 44, marginBottom: 22, color: 'var(--text)' }}>Маркетплейсы</h3>
        <IntegrationGrid items={MARKETPLACE} />
        <h3 style={{ fontSize: 26, fontWeight: 700, marginTop: 48, marginBottom: 22, color: 'var(--text)' }}>Импорт и экспорт данных</h3>
        <IntegrationGrid items={DATA_IMPORT} />
        <h3 style={{ fontSize: 26, fontWeight: 700, marginTop: 48, marginBottom: 22, color: 'var(--text)' }}>API и автоматизация</h3>
        <IntegrationGrid items={API_INTEGRATIONS} />
        <div style={{ textAlign: 'center', marginTop: 52 }}>
          <a href={formHref('/request-demo.html', theme)} className="btn-mk-primary">Обсудить интеграции</a>
