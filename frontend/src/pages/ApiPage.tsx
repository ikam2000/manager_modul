    ...
    <div style={{ background: 'var(--bg)' }}>
      <Section style={{ padding: '120px 0 64px' }} background="light">
        ...
        <FeatureGrid columns={3}>
          {BLOCKS.map((block) => (
            <div key={block.title} className="mk-band-card" style={{ padding: 26 }}>
              ...
              <p style={{ fontSize: 15, lineHeight: 1.75, color: 'var(--text-secondary)', marginBottom: 16 }}>{block.description}</p>
        ...
        <div style={{ textAlign: 'center', marginTop: 48 }}>
          <a href={formHref('/request-demo.html', theme)} className="btn-mk-primary">Обсудить API</a>
